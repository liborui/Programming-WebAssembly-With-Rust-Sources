...
var Game = {
    ...
    generateMap: function () {
        ...
        var digCallback = function (x, y, value) {
            ...
            this.engine.on_dig(x, y, value); //(1)Invoke the on_dig function on the Rust Engine struct.
        }
        digger.create(digCallback.bind(this));

        this.generateBoxes(freeCells);
        this.engine.draw_map(); //(2)Invoke the draw_map function on the Rust Engine struct.2

        this.player = this._createBeing(Player, freeCells); // (3)Here this refers to the Game class instance and we call a utility function to create an instance of either a player or an enemy to put on the map.
...
var Player = function (x, y) {
    // This creates an instance of the PlayerCore class, 
    // which is actually a Rust struct you’ll write shortly that, 
    // through the power of wasm_bindgen, looks to JavaScript like an ordinary class.
